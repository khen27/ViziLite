...
const isValidDate = (digits: string[]) => {
  // Check if all 8 digits are filled
  ...
  // Check age >= 18 (simplified calculation)
...
const BirthdayScreen = () => {
  ...
  const handleDigitChange = (idx: number, val: string) => {
    ...
    const isValid = isValidDate(newDigits);
    console.log('Date validation:', newDigits.join(''), 'Valid:', isValid);
